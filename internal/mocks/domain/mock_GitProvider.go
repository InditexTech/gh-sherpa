...
func (_m *MockGitProvider) CheckoutNewBranchFromOrigin(branch string, base string) error {
	...
	if len(ret) == 0 {
		panic("no return value specified for CheckoutNewBranchFromOrigin")
	}
...
func (_m *MockGitProvider) CommitEmpty(message string) error {
	...
	if len(ret) == 0 {
		panic("no return value specified for CommitEmpty")
	}
...
func (_m *MockGitProvider) FetchBranchFromOrigin(branch string) error {
	...
	if len(ret) == 0 {
		panic("no return value specified for FetchBranchFromOrigin")
	}
...
func (_m *MockGitProvider) GetCommitsToPush(branch string) ([]string, error) {
	...
	if len(ret) == 0 {
		panic("no return value specified for GetCommitsToPush")
	}
...
// GetRepositoryRoot provides a mock function with no fields
func (_m *MockGitProvider) GetRepositoryRoot() (string, error) {
	ret := _m.Called()

	if len(ret) == 0 {
		panic("no return value specified for GetRepositoryRoot")
	}
...
func (_m *MockGitProvider) PushBranch(branch string) error {
	...
	if len(ret) == 0 {
		panic("no return value specified for PushBranch")
	}
...
func (_m *MockGitProvider) RemoteBranchExists(branch string) bool {
	...
	if len(ret) == 0 {
		panic("no return value specified for RemoteBranchExists")
	}
