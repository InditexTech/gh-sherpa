...
// CreateWorktree provides a mock function with given fields: path, branch, base
func (_m *MockGitProvider) CreateWorktree(path string, branch string, base string) error {
	ret := _m.Called(path, branch, base)

	var r0 error
	if rf, ok := ret.Get(0).(func(string, string, string) error); ok {
		r0 = rf(path, branch, base)
	} else {
		r0 = ret.Error(0)
	}
...
// MockGitProvider_CreateWorktree_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'CreateWorktree'
type MockGitProvider_CreateWorktree_Call struct {
	*mock.Call
}
...
//   - branch string
//   - base string
func (_e *MockGitProvider_Expecter) CreateWorktree(path interface{}, branch interface{}, base interface{}) *MockGitProvider_CreateWorktree_Call {
	return &MockGitProvider_CreateWorktree_Call{Call: _e.mock.On("CreateWorktree", path, branch, base)}
}

func (_c *MockGitProvider_CreateWorktree_Call) Run(run func(path string, branch string, base string)) *MockGitProvider_CreateWorktree_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockGitProvider_CreateWorktree_Call) Return(err error) *MockGitProvider_CreateWorktree_Call {
	_c.Call.Return(err)
	return _c
}

func (_c *MockGitProvider_CreateWorktree_Call) RunAndReturn(run func(string, string, string) error) *MockGitProvider_CreateWorktree_Call {
	_c.Call.Return(run)
	return _c
}

// ListWorktrees provides a mock function with given fields:
func (_m *MockGitProvider) ListWorktrees() ([]domain.Worktree, error) {
	ret := _m.Called()

	var r0 []domain.Worktree
	var r1 error
	if rf, ok := ret.Get(0).(func() ([]domain.Worktree, error)); ok {
		return rf()
	}
	if rf, ok := ret.Get(0).(func() []domain.Worktree); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]domain.Worktree)
		}
	}
...
// MockGitProvider_ListWorktrees_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'ListWorktrees'
type MockGitProvider_ListWorktrees_Call struct {
	*mock.Call
}

// ListWorktrees is a helper method to define mock.On call
func (_e *MockGitProvider_Expecter) ListWorktrees() *MockGitProvider_ListWorktrees_Call {
	return &MockGitProvider_ListWorktrees_Call{Call: _e.mock.On("ListWorktrees")}
}

func (_c *MockGitProvider_ListWorktrees_Call) Run(run func()) *MockGitProvider_ListWorktrees_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run()
	})
	return _c
...
func (_c *MockGitProvider_ListWorktrees_Call) Return(worktrees []domain.Worktree, err error) *MockGitProvider_ListWorktrees_Call {
	_c.Call.Return(worktrees, err)
	return _c
}

func (_c *MockGitProvider_ListWorktrees_Call) RunAndReturn(run func() ([]domain.Worktree, error)) *MockGitProvider_ListWorktrees_Call {
	_c.Call.Return(run)
	return _c
}

// RemoveWorktree provides a mock function with given fields: path
func (_m *MockGitProvider) RemoveWorktree(path string) error {
	ret := _m.Called(path)
...
// MockGitProvider_RemoveWorktree_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'RemoveWorktree'
type MockGitProvider_RemoveWorktree_Call struct {
	*mock.Call
}

// RemoveWorktree is a helper method to define mock.On call
//   - path string
func (_e *MockGitProvider_Expecter) RemoveWorktree(path interface{}) *MockGitProvider_RemoveWorktree_Call {
	return &MockGitProvider_RemoveWorktree_Call{Call: _e.mock.On("RemoveWorktree", path)}
}

func (_c *MockGitProvider_RemoveWorktree_Call) Run(run func(path string)) *MockGitProvider_RemoveWorktree_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(string))
	})
	return _c
...
func (_c *MockGitProvider_RemoveWorktree_Call) Return(err error) *MockGitProvider_RemoveWorktree_Call {
	_c.Call.Return(err)
	return _c
}

func (_c *MockGitProvider_RemoveWorktree_Call) RunAndReturn(run func(string) error) *MockGitProvider_RemoveWorktree_Call {
	_c.Call.Return(run)
	return _c
}
