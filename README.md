...
- [Installation](#installation)
  - [Option 1: Install as a GitHub CLI extension (recommended)](#option-1-install-as-a-github-cli-extension-recommended)
  - [Option 2: From source](#option-2-from-source)
  - [Option 3: Using `go install`](#option-3-using-go-install)
  - [Option 4: Download the binary file](#option-4-download-the-binary-file)
- [Usage](#usage)
...
>NOTE: as stated in the [`Build / install from source`](#build--install-from-source) section, you can also use `make install` to install the extension as a binary os jut run the generated binary after a `make build` execution.
